...
JOB_FIELDS = {
    ...
    "Marketing": {
        "Technical": [
            "How do you approach marketing analytics and measurement?",
            "What's your experience with marketing automation platforms?",
            "Describe your approach to SEO and content optimization.",
            "How do you use data to inform marketing decisions?",
            "What's your experience with A/B testing in marketing campaigns?",
            "How do you approach customer segmentation and targeting?",
            "Describe your experience with email marketing platforms and strategies.",
            "What's your approach to social media marketing and management?",
            "How do you measure ROI for different marketing channels?",
            "What's your experience with paid advertising (PPC, social ads, etc.)?",
            "How do you approach marketing attribution and tracking?",
            "Describe your experience with CRM systems and lead management.",
            "What's your approach to content management and publishing workflows?",
            "How do you use marketing technology stack integration?",
            "What's your experience with conversion rate optimization?",
            "How do you approach competitive analysis and market research?",
            "Describe your experience with event marketing and trade shows.",
            "What's your approach to brand management and consistency?",
            "How do you handle marketing compliance and legal considerations?",
        ...
        "Behavioral": [
            ...
            "How do you handle tight deadlines and multiple campaign launches?",
            "Tell me about a time you had to pivot your marketing strategy quickly.",
            "How do you collaborate with sales teams to align on messaging?",
            "Describe a situation where you had to work with a limited budget.",
            "Tell me about a time you had to convince stakeholders to try a new approach.",
            "How do you handle negative feedback or PR situations?",
            "Describe a time when you successfully entered a new market segment.",
            "Tell me about a situation where you had to manage external agencies or vendors.",
            "How do you approach building relationships with media and influencers?",
            "Describe a time when you had to present results to senior leadership.",
            "Tell me about a situation where you had to coordinate across multiple departments.",
            "How do you handle creative differences with design or content teams?",
            "Describe a time when you successfully launched a product or service.",
            "Tell me about a situation where you had to manage a crisis communications.",
            "How do you approach understanding and reaching new customer personas?",
            "Describe a time when you used customer feedback to improve marketing.",
            "Tell me about a situation where you had to work with international markets.",
            "How do you stay motivated during long-term brand building efforts?"
        ],
        "Role-specific": [
            "How do you develop and execute integrated marketing campaigns?",
            "What's your approach to brand positioning and messaging?",
            "How do you measure and optimize customer acquisition costs?",
            "Describe your experience with product marketing and go-to-market strategies.",
            "How do you approach customer retention and lifecycle marketing?",
            "What's your experience with content marketing and storytelling?",
            "How do you handle marketing budget planning and allocation?",
            "Describe your approach to public relations and media outreach.",
            "How do you develop marketing strategies for different customer segments?",
            "What's your experience with digital transformation in marketing?",
            "How do you approach marketing team leadership and development?",
            "Describe your experience with global or multi-market campaigns.",
            "How do you ensure marketing alignment with overall business strategy?",
            "What's your approach to emerging marketing channels and technologies?",
            "How do you handle marketing performance reporting and optimization?",
            "Describe your experience with customer experience and journey mapping.",
            "How do you approach marketing research and consumer insights?",
            "What's your experience with regulatory compliance in marketing?",
            "How do you manage marketing partnerships and collaborations?",
            "Describe your approach to innovation and experimentation in marketing."
        ]
    },
    "Sales": {
        "Technical": [
            ...
            "Describe your approach to lead qualification and scoring.",
            "How do you use data and analytics in your sales process?",
            "What's your experience with sales automation and productivity tools?",
            "How do you approach territory planning and account mapping?",
            "Describe your experience with proposal and contract management.",
            "What's your approach to pricing strategies and negotiations?",
            "How do you handle complex sales cycles and decision-making processes?",
            "What's your experience with channel partner and reseller management?",
            "How do you approach competitive analysis and positioning?",
            "Describe your experience with product demonstrations and presentations.",
            "What's your approach to customer onboarding and success management?",
            "How do you use social selling and digital prospecting techniques?",
            "What's your experience with sales training and enablement tools?",
            "How do you approach international sales and cultural considerations?",
            "Describe your experience with enterprise vs. SMB sales approaches.",
            "What's your approach to referral programs and customer advocacy?",
            "How do you handle sales compliance and regulatory requirements?",
            "What's your experience with sales performance metrics and KPIs?"
        ],
        "Behavioral": [
            "Tell me about your biggest sales success and what made it work.",
            "Describe a time when you lost a deal and what you learned from it.",
            "How do you handle rejection and maintain motivation?",
            "Tell me about a time you exceeded your sales targets significantly.",
            "Describe a situation where you had to rebuild a relationship with a client.",
            "How do you approach working with difficult or demanding customers?",
            "Tell me about a time you had to sell to a skeptical or resistant prospect.",
            "Describe a situation where you had to collaborate with other departments.",
            "How do you handle competing priorities and time management?",
            "Tell me about a time you successfully upsold or cross-sold to a client.",
            "Describe a situation where you had to learn about a new industry quickly.",
            "How do you approach building long-term customer relationships?",
            "Tell me about a time you had to deliver bad news to a customer.",
            "Describe a situation where you turned around a failing customer relationship.",
            "How do you handle pressure during important negotiations?",
            "Tell me about a time you had to present to senior executives.",
            "Describe a situation where you successfully entered a new market.",
            "How do you approach mentoring junior sales team members?",
            "Tell me about a time you had to adapt your sales approach for a specific client.",
            "Describe a situation where you successfully managed a complex, multi-stakeholder sale."
        ],
        "Role-specific": [
            "How do you develop and execute sales strategies for new markets?",
            "What's your approach to building and managing a sales pipeline?",
            "Describe your experience with consultative selling techniques.",
            "How do you handle objection handling and closing strategies?",
            "What's your approach to customer needs analysis and discovery?",
            "How do you manage key accounts and strategic relationships?",
            "Describe your experience with sales team leadership and coaching.",
            "What's your approach to sales compensation and incentive design?",
            "How do you handle sales territory disputes and collaboration?",
            "Describe your experience with trade shows and sales events.",
            "What's your approach to customer retention and churn prevention?",
            "How do you develop sales collateral and enablement materials?",
            "Describe your experience with sales operations and process improvement.",
            "What's your approach to handling price objections and value selling?",
            "How do you manage sales partnerships and channel relationships?",
            "Describe your experience with subscription or recurring revenue models.",
            "What's your approach to sales reporting and performance analysis?",
            "How do you handle customer escalations and relationship recovery?",
            "Describe your experience with digital sales transformation.",
            "What's your approach to sales forecasting accuracy and methodology?",
            "How do you ensure sales and marketing alignment and collaboration?"
        ]
    },
    "Human Resources": {
        "Technical": [
            ...
            "Describe your approach to performance management and reviews.",
            "How do you handle compensation and benefits analysis?",
            "What's your experience with employment law and compliance?",
            "How do you approach organizational development and change management?",
            "Describe your experience with employee engagement surveys and analysis.",
            "What's your approach to learning and development program design?",
            "How do you handle workplace investigations and conflict resolution?",
            "What's your experience with diversity, equity, and inclusion initiatives?",
            "How do you approach workforce planning and analytics?",
            "Describe your experience with employee onboarding and orientation.",
            "What's your approach to succession planning and career development?",
            "How do you handle employee relations and grievance procedures?",
            "What's your experience with HR metrics and dashboard reporting?",
            "How do you approach job analysis and job description development?",
            "Describe your experience with remote work policies and management.",
            "What's your approach to employee recognition and retention programs?",
            "How do you handle terminations and offboarding processes?",
            "What's your experience with labor relations and union negotiations?",
            "How do you approach HR policy development and communication?",
            "Describe your experience with background checks and pre-employment screening.",
            "What's your approach to workplace safety and workers' compensation?",
            "How do you handle international HR and global workforce management?",
            "What's your experience with HR data privacy and security?"
        ],
        "Behavioral": [
            "Tell me about a time you helped resolve a difficult employee situation.",
            "Describe a situation where you had to deliver difficult news to an employee.",
            "How do you handle confidential information and maintain trust?",
            "Tell me about a time you successfully implemented a new HR program.",
            "Describe a situation where you had to mediate between conflicting parties.",
            "How do you approach building relationships across different departments?",
            "Tell me about a time you had to adapt HR policies for changing business needs.",
            "Describe a situation where you successfully improved employee satisfaction.",
            "How do you handle situations where employees disagree with company policies?",
            "Tell me about a time you had to work with limited resources to solve an HR challenge.",
            "Describe a situation where you successfully coached a manager through an employee issue.",
            "How do you approach supporting employees during organizational changes?",
            "Tell me about a time you had to present HR metrics to senior leadership.",
            "Describe a situation where you successfully recruited hard-to-find talent.",
            "How do you handle pressure from managers who want to bypass HR processes?",
            "Tell me about a time you had to deal with an ethics or compliance violation.",
            "Describe a situation where you successfully retained a valuable employee.",
            "How do you approach working with employees from diverse backgrounds?",
            "Tell me about a time you had to learn new employment law quickly.",
            "Describe a situation where you successfully managed an employee's career transition."
        ],
        "Role-specific": [
            "How do you develop talent acquisition strategies for different roles?",
            "What's your approach to creating inclusive hiring and promotion practices?",
            "How do you measure and improve employee engagement?",
            "Describe your experience with compensation benchmarking and market analysis.",
            "What's your approach to designing effective performance management systems?",
            "How do you handle employee development and career pathing?",
            "Describe your experience with organizational culture assessment and development.",
            "What's your approach to managing HR during mergers and acquisitions?",
            "How do you ensure compliance with evolving employment regulations?",
            "Describe your experience with executive coaching and leadership development.",
            "What's your approach to building HR business partnerships?",
            "How do you handle workforce restructuring and layoffs sensitively?",
            "Describe your experience with global HR operations and cultural considerations.",
            "What's your approach to HR technology implementation and change management?",
            "How do you develop and communicate HR policies effectively?",
            "Describe your experience with employee wellness and mental health programs.",
            "What's your approach to managing HR budgets and ROI measurement?",
            "How do you handle crisis communication and employee communications?",
            "Describe your experience with HR transformation and modernization.",
            "What's your approach to building high-performing HR teams?"
        ]
    },
    "Finance/Accounting": {
        "Technical": [
            "How do you approach financial analysis and reporting?",
            "What's your experience with budgeting and forecasting processes?",
            "Describe your approach to cash flow management and analysis.",
            "How do you handle month-end and year-end closing procedures?",
            "What's your experience with financial systems and ERP platforms?",
            "How do you approach variance analysis and cost control?",
            "Describe your experience with audit preparation and external auditors.",
            "What's your approach to accounts payable and receivable management?",
            "How do you handle tax compliance and planning?",
            "What's your experience with financial controls and SOX compliance?",
            "How do you approach pricing analysis and profitability assessment?",
            "Describe your experience with financial modeling and scenario planning.",
            "What's your approach to capital expenditure analysis and approval?",
            "How do you handle inventory valuation and cost accounting?",
            "What's your experience with treasury management and banking relationships?",
            "How do you approach risk assessment and financial risk management?",
            "Describe your experience with international accounting and currency hedging.",
            "What's your approach to financial dashboard creation and KPI tracking?",
            "How do you handle acquisition accounting and due diligence?",
            "What's your experience with regulatory reporting and compliance?",
            "How do you approach process improvement and automation in finance?",
            "Describe your experience with cost allocation and transfer pricing.",
            "What's your approach to financial planning for growth and expansion?",
            "How do you handle debt management and financing decisions?",
            "What's your experience with financial systems implementation?"
        ],
        "Behavioral": [
            ...
            "How do you handle tight month-end deadlines and pressure?",
            "Tell me about a time you successfully implemented a cost-saving initiative.",
            "Describe a situation where you had to work with incomplete or challenging data.",
            "How do you approach building relationships with non-finance departments?",
            "Tell me about a time you had to present financial results to senior management.",
            "Describe a situation where you successfully streamlined a financial process.",
            "How do you handle situations where actuals significantly differ from budget?",
            "Tell me about a time you had to learn new accounting standards quickly.",
            "Describe a situation where you successfully managed through a financial crisis.",
            "How do you approach working with external auditors during busy seasons?",
            "Tell me about a time you had to make a difficult financial recommendation.",
            "Describe a situation where you successfully supported business decision-making with analysis.",
            "How do you handle conflicting priorities during financial reporting periods?",
            "Tell me about a time you identified and resolved a system or process issue.",
            "Describe a situation where you successfully trained someone on financial procedures.",
            "How do you approach working with international teams or regulations?",
            "Tell me about a time you had to defend your financial analysis or recommendations.",
            "Describe a situation where you successfully led a finance team project."
        ],
        "Role-specific": [
            "How do you develop financial forecasts and business planning models?",
            "What's your approach to supporting business development and pricing decisions?",
            "How do you ensure accurate and timely financial reporting?",
            "Describe your experience with financial analysis for strategic initiatives.",
            "What's your approach to managing relationships with banks and investors?",
            "How do you handle financial aspects of contract negotiations?",
            "Describe your experience with financial due diligence and M&A support.",
            "What's your approach to developing and monitoring financial KPIs?",
            "How do you support operational teams with financial insights?",
            "Describe your experience with financial process documentation and training.",
            "What's your approach to managing financial teams and development?",
            "How do you handle financial planning for multiple business units?",
            "Describe your experience with financial systems integration projects.",
            "What's your approach to ensuring compliance with financial regulations?",
            "How do you develop financial policies and procedures?",
            "Describe your experience with board reporting and investor relations.",
            "What's your approach to managing working capital and liquidity?",
            "How do you handle financial analysis for product or service lines?",
            "Describe your experience with financial transformation and optimization.",
            "What's your approach to building financial partnerships across the organization?"
        ]
    }
}
